...
const Register = () => {
	...
	<form onSubmit={handelSubmite} action="" className="space-y-6 ng-untouched ng-pristine ng-valid">
	...
	<div className="flex justify-center space-x-4">
		<button onClick={handelGoogleSign} aria-label="Log in with Google" className="p-3 rounded-sm">
