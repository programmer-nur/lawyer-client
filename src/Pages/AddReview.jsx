...
const AddReview = () => {
	...
	<div className="flex flex-col items-center w-full">
        ...
        <div className="col-span-full sm:col-span-3 my-3">
					...
					<input id="firstname" type="text" placeholder="First name" className="w-full p-2 rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900" />
				</div>
				<div className="col-span-full my-4 sm:col-span-3">
					<label for="email" className="text-sm">Email</label>
					<input id="email" type="text" placeholder="Email" className="w-full rounded-md focus:ring focus:ring-opacity-75 p-2 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900" />
				</div>
